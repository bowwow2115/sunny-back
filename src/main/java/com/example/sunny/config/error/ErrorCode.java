...
public enum ErrorCode {
    ...
    INVAILDCONTENTCLASS(400,"INVAILDCONTENTCLASS",""),
    SQLEXCEPTION(400,"SQLEXCEPTION",""),
    FILEIOEXCEPTION(400,"FILEIOEXCEPTION",""),
    EXCEPTION(400,"EXCEPTION",""),
    AUTHALREADYEXISTS(400,"AUTHALREADYEXISTS",""),
    USERALREADYEXISTS(400,"USERALREADYEXISTS",""),
    GROUPNOTFOUND(400,"GROUPNOTFOUND",""),
    AUTHEXCEPTION(400,"AUTHEXCEPTION",""),
    USERNOTFOUND(400,"USERNOTFOUND",""),
    USEREXCEPTION(400,"USEREXCEPTION",""),
    USERDISABLED(400,"USERDISABLED",""),
    PASSWORDEMPTY(400,"PASSWORDEMPTY",""),
    APIEXCEPTION(400,"APIEXCEPTION",""),
    PERMISSION_ERROR(403, "PERMISSION_ERROR", ""),
    STATBATCHJOB_ERROR(400,"STATBATCHJOB_ERROR", ""),
